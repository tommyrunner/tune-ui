<template>
  <div class="demo-slider">
    <div class="slider-item">
      <p class="slider-label">Slider with Number Input</p>
    ...
    <div class="slider-item">
      <p class="slider-label">Range Slider with Number Inputs</p>
      <div class="slider-input-container">
...
const updateRangeMax = val => {
  // Ensure maximum value is not less than minimum value
