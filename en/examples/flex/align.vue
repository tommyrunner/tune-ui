<template>
  <div class="demo-container">
    <p class="demo-desc">Set the alignment of elements within the flex container through justify and align properties.</p>

    <h4 class="section-title">Horizontal Alignment (justify)</h4>
    <div class="demo-section">
      <div class="demo-item">
        <p class="demo-label">start (default)</p>
    ...
    <h4 class="section-title">Vertical Alignment (align)</h4>
    <div class="demo-section">
      <div class="demo-item">
        <p class="demo-label">center (default)</p>
