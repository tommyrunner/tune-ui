        ...
        <div class="_time-panel-wrapper">
          ...
          <div class="_time-lists-container">
            ...
            <div class="_time-list-column">
              <div class="_time-column-title">{{ TEXT_HOUR }}</div>
            ...
            <!-- 分钟列表 -->
            <div class="_time-list-column">
              <div class="_time-column-title">{{ TEXT_MINUTE }}</div>
            ...
            <!-- 秒列表 -->
            <div class="_time-list-column">
              <div class="_time-column-title">{{ TEXT_SECOND }}</div>
          ...
          <div class="_time-actions">
            <button class="_time-btn _confirm" @click="confirmTimeSelect">{{ TEXT_CONFIRM }}</button>
            <button class="_time-btn _cancel" @click="cancelTimeSelect">{{ TEXT_CANCEL }}</button>
          </div>
        </div>
      </template>
    </t-popover>
